...
export class AssignmentsController {
  ...
  /** Mentor bulk-assigns one task to many students. */
  @Post('bulk')
  @Roles(Role.MENTOR, Role.ADMIN, Role.SUPER_ADMIN)
  bulk(@Body() dto: BulkAssignmentDto, @CurrentUser() actor: AuthenticatedUser) {
    return this.assignments.bulkAssign(dto, actor);
  }
